...
/*
  Perche` il calcolo in formato double produce un errore di due unita`? non abbiamo convertito il long in decimale
  ...
  Ci sono ancora errori nella sottrazione AMOUNT-DISCOUNT? Perche`? si ci sono ancora errori di sottrazione perche' nella conversione vengono effetuati errori di trunk
*/
